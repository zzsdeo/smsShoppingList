...
public abstract class StandOutWindow extends Service {
	 ...
	 * @param cls
	 *            The Service extending {@link wei.mark.standout.StandOutWindow} that will be used
	 ...
	 *            A Context of the application package implementing this class.
	 * @param cls
	 *            The Service extending {@link wei.mark.standout.StandOutWindow} that is managing
	 *            the window.
	 * @param id
	 ...
	 *            the sending window.
	 * @param toCls
	 *            The Service's class extending {@link wei.mark.standout.StandOutWindow} that is
	...
	/**
	 * Return the {@link wei.mark.standout.StandOutWindow#LayoutParams} for the corresponding id.
	 ...
	 * @return The {@link wei.mark.standout.StandOutWindow#LayoutParams} corresponding to the id.
	 ...
	 *         continue.
	 * @see #updateViewLayout(int, Window, wei.mark.standout.StandOutWindow.StandOutLayoutParams)
	 */
